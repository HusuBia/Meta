        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="shadow-lg mb-8">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-end">
                <Button onClick={scheduleMeeting} className="bg-purple-600 text-white px-8 py-3 rounded-xl hover:bg-purple-700 transition">
                  Schedule
                </Button>
              </div>
            </CardContent>
          ...
          <Card className="shadow-lg mb-8">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex justify-end">
                <Button onClick={submitReview} className="bg-purple-600 text-white px-8 py-3 rounded-xl hover:bg-purple-700 transition">
                  Submit Review
                </Button>
              </div>
            </CardContent>
          ...
          <div className="flex justify-start">
            <Button onClick={goBack} className="bg-gray-500 text-white px-8 py-3 rounded-xl hover:bg-gray-600 transition">
              ⬅ Back
            </Button>
          </div>
        </div>
